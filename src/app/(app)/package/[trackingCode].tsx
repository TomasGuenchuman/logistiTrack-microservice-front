...
// NOTA: Este screen es el que se muestra al escanear un código QR, por lo que recibe el trackingCode por parámetro en la URL (ver app/(app)/(tabs)/scan/index.tsx)
